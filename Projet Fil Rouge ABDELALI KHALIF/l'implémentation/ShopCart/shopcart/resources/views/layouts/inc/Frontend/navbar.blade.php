        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                    <h5 class="brand-name">shopcart</h5>
                    {{-- <img src="/uploads/app/logo_shopcart_.png" width="90px" height="70px" alt=""> --}}
                </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('cart') }}">
                                ...
                                <div class="cart">
                                    ...
                                    <span class="count-cart text-center"><livewire:frontend.cart.cart-count/></span>
                                </div>
                            </a>
                        </li>
